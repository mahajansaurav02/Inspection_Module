...
const getStoredData = () => {
  ...
  const initailechSlave = localStorage.getItem('echSlave');
...
export default () => {
  ...
  const [echSlave, setechSlave] = useState(initailechSlave);
  ...
  const details = (
    ...
    localStorage.setItem('echSlave', echSlavePostLogin);
