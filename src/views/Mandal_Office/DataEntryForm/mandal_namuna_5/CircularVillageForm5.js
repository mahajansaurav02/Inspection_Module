...
import CircularDataentryForm5 from './CircularDataentryForm5'
...
const CircularVillageForm5 = () => {
  ...
  const navigateToDataentryPage = () => {
    navigate('/Mandal_Office/DataEntryForm/CircularDataentryForm5')
  }
  ...
  return (
    <>
      ...
      >
        <CModalHeader>
          <CModalTitle id="ScrollingLongContentExampleLabel">मंडळ नमुना पाच Edit</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CircularDataentryForm5 isEdit={true} />
        </CModalBody>
      </CModal>
    </>
  )
...
export default CircularVillageForm5
