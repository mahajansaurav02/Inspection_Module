...
import CircularDataentryForm4 from './CircularDataentryForm4'
...
const CircularVillageForm4 = () => {
  ...
  const navigateToDataentryPage = () => {
    navigate('/Mandal_Office/DataEntryForm/CircularDataentryForm4')
  }
  ...
  return (
    <>
      ...
      >
        <CModalHeader>
          <CModalTitle id="ScrollingLongContentExampleLabel">मंडळ नमुना चार Edit</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CircularDataentryForm4 isEdit={true} />
        </CModalBody>
      </CModal>
    </>
  )
...
export default CircularVillageForm4
