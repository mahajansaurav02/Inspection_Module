...
import CircularDataentryForm2 from './CircularDataentryForm2'
...
const CircularVillageForm3 = () => {
  ...
  const navigateToDataentryPage = () => {
    navigate('/Mandal_Office/DataEntryForm/CircularDataentryForm2')
  }
  ...
  return (
    <>
      ...
      >
        <CModalHeader>
          <CModalTitle id="ScrollingLongContentExampleLabel">मंडळ नमुना दोन Edit</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CircularDataentryForm2 />
        </CModalBody>
      </CModal>
    </>
  )
