                    ...
                    <CTableHead color="dark">
                      <CTableRow>
                        ...
                        <CTableHeaderCell scope="col">
                          भेट देणाऱ्या अधिकाऱ्याचे नाव व हुद्दा{' '}
                        </CTableHeaderCell>
                        <CTableHeaderCell scope="col">भेटीचा दिनांक</CTableHeaderCell>
                        <CTableHeaderCell scope="col">भेटीचे कारण</CTableHeaderCell>
                        <CTableHeaderCell scope="col">शेरा / शक</CTableHeaderCell>
                        <CTableHeaderCell scope="col">
