...
const ViewInspection = ({ visible, setVisible, modelData }) => {
        ...
        <CModalHeader>
          <CRow>
            <CModalTitle id="VerticallyCenteredExample">
              <h5>Id:{modelData?.talathiId}</h5>
              <h5>Name:{modelData?.talathiName}</h5>
              <h5>Village:{modelData?.villageName}</h5>
            </CModalTitle>
          </CRow>{' '}
          ...
          <CTable bordered style={{ textAlign: 'center' }}>
            <tbody>
              ...
              <tr>
                <th>2</th>
                <td colSpan={2}>
                  जिल्हा अधिक्षक भूमी अभिलेख यांचेकडून आलेली पोटहिस्सा आणि कम-जास्ती पत्रके दप्तरी
                  उपलब्ध आहेत काय ?
                </td>
                <td>{state?.que2}</td>
              </tr>
              ...
              <tr>
                ...
                <td>नोंद क्र.</td>
                <td>{state?.que5?.nondKramank ? state?.que5?.nondKramank : '__'}</td>
              </tr>
              <tr>
                <td>कजाप</td>
                <td>{state?.que5?.kajapa ? state?.que5?.kajapa : '__'}</td>
              </tr>
              <tr>
                <td>आकारफोड पत्रक</td>
                <td>{state?.que5?.akarfodPatrak ? state?.que5?.akarfodPatrak : '__'}</td>
              </tr>
              <tr>
                <td>कबुलायत</td>
                <td>{state?.que5?.kabulayat ? state?.que5?.kabulayat : '__'}</td>
              </tr>
              <tr>
                <td>गा.न.७/१२</td>
                <td>{state?.que5?.gaonNo7_12 ? state?.que5?.gaonNo7_12 : '__'}</td>
              </tr>
              <tr>
                <td>गा.न.१क</td>
                <td>{state?.que5?.gaonNo1C ? state?.que5?.gaonNo1C : '__'}</td>
              </tr>
              <tr>
                <td>गा.न. २</td>
                <td>{state?.que5?.gaonNo2 ? state?.que5?.gaonNo2 : '__'}</td>
              </tr>
              <tr>
                <td>गा.न. ३</td>
                <td>{state?.que5?.gaonNo3 ? state?.que5?.gaonNo3 : '__'}</td>
              </tr>
              {/*-------------------------------------------------------------Q.6----  */}
              <tr>
                <th>6</th>
              ...
              {/*-------------------------------------------------------------Q.7----  */}
              <tr>
                <th rowSpan={state?.que7?.que7 == 'होय' ? 3 : 1}>7</th>
                <td colSpan={2}>
                  गोषवान्यातील क्षेत्र व आकार गावचे अंतिम कमी जास्त पत्रक, गा.न.क्र. १अ, श्व, एक. २
                  आणि ३ मध्ये दर्शविलेले क्षेत्र व आकारणी बाबत जुळतात का ते पहा.
                </td>
                <td>{state?.que7?.que7}</td>
              </tr>
              {state?.que7?.que7 == 'होय' && (
                <>
                  <tr>
                  ...
                  <tr>
                    <td colSpan={1}></td>
                    <td>आकार ..</td>
                    <td>{state?.que7?.aakarQue7 ? state?.que7?.aakarQue7 : '__'}</td>
                  </tr>
                </>
              )}
              {/*-------------------------------------------------------------Q.8----  */}
            ...
            <CTable bordered style={{ textAlign: 'center' }}>
              <tbody>
                ...
                <tr>
                  <th rowSpan={8}>5</th>
                  <td rowSpan={8}>
                    गा.न.क्र. १ मधील दुरुस्त केलेल्या तीन नोंदी घ्या व त्यांच्या अनुषंगिक नोंदीसाठी
                    फ. क.जा.प., आकारफोड. पत्रक, कबुलायत, गा.न.क्र.७/१२, १ क. २ आणि ३ यांची तपासणी
                    करा ?
                  </td>
                  <td>नोंद क्र.</td>
                ...
                <tr>
                  ...
                  <td colSpan={2}>
                    गोषवान्यातील क्षेत्र व आकार गावचे अंतिम कमी जास्त पत्रक, गा.न.क्र. १अ, श्व, एक.
                    २ आणि ३ मध्ये दर्शविलेले क्षेत्र व आकारणी बाबत जुळतात का ते पहा.
                  </td>
